...
public class Vilao : MonoBehaviour {
	...
	public Animator inimigomovendo;

	void Start () {


		inimigomovendo = GetComponent<Animator> ();
	}
	...
	void Update () {
		...
		if((liberaPer == true) && distancia > 2.8f)
		{
			...
			inimigomovendo.SetBool ("InimigoAnda", true);
			inimigomovendo.SetBool ("InimigoIdle", false);
			...
			inimigomovendo.SetBool ("InimigoAnda",false);
			inimigomovendo.SetBool ("InimigoIdle",true);
		}
